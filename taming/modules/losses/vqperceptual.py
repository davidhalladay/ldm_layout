...
class VQLPIPSWithDiscriminator(nn.Module):
    ...
    def forward(self, codebook_loss, inputs, reconstructions, optimizer_idx,
        ...
        if xrec_aux is not None:
            ...
            # inputs_cv = torchvision.utils.make_grid(inputs)
            # inputs_aux_cv = torchvision.utils.make_grid(inputs_aux)
            # torchvision.utils.save_image(inputs_cv, "input.png")
            # torchvision.utils.save_image(inputs_aux_cv, "input_aux.png")
