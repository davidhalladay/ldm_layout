...
class ImageLogger(Callback):
    def __init__(self, batch_frequency, max_images, clamp=True, increase_log_steps=True, get_codebook=False, test_postfix=''):
        super().__init__()
    ...
    try:
        ...
        default_callbacks_cfg = {
            ...
            "image_logger": {
                ...
                "params": {
                    "batch_frequency": 100 if opt.train else 1,
        ...
        if not opt.no_test and not trainer.interrupted:
            ...
            if opt.uncond_gen_mode:
                ...
                print('rrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrr', torch.randn(1))
